...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		...
		email: "Please enter a valid email address. For example mail@domain.co.uk",
		url: "Please enter a valid URL. For example http://www.serioussandwichpeopleltd.com/",
		date: "Please enter a valid date. For example 17/04/2007",
		...
		ukpostcode: "Please enter a valid postcode. For exemple PO19 3NP.",
	...
	methods: {
		...
		ukpostcode: function(value, element) {
			return this.optional(element) || /^[A-Z]{1,2}\d[\dA-Z]?\s?\d[A-Z]{2}$/i.test(value);
		},
